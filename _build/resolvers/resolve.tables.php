...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('imgarea_core_path', null, $modx->getOption('core_path').'components/imgarea/').'model/';
            $modx->addPackage('imgarea', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH.'components/imgarea/model/schema/imgarea.mysql.schema.xml';
